...
ghosts.forEach(g => {
    g.elementAddColor(document.querySelectorAll("#board>div")[(g.v9)+g.h]);
    g.interval=setInterval(() => {
        ...
        g.elementRemoveColor(document.querySelectorAll("#board>div")[(g.v9)+g.h]);
...
const checkCollision = g => {
    ...
    if (g.v==position.v && g.h==position.h) {
        ...
        if (document.querySelectorAll("#board>div")[(g.v*19)+g.h].classList.contains("blue")) {
            g.elementRemoveColor(document.querySelectorAll("#board>div")[(g.v*9)+g.h]);
            g.removeColor("blue");
            g.h=9;
            g.v=9;
            g.elementAddColor(document.querySelectorAll("#board>div")[(g.v*9)+g.h]);
            score=score+10;
...
const gCanRight = g => screenDraw[g.v][g.h+1]==1 || g.h+1==9;
