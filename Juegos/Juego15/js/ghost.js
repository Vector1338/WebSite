...
ghosts.forEach(g => {
    ...
    g.interval=setInterval(() => {
        ...
        g.elementRemoveColor(document.querySelectorAll("#board>div")[(g.v*30)+g.h]);
...
const gCanRight = g => screenDraw[g.v][g.h+1]==1 || g.h+1==30;
...
function endGame() {
    ...
    setInterval(() => {
        document.querySelectorAll("#board>div")[(position.v*30)+position.h].classList.toggle("comecocos")
    }, 1000);
}
